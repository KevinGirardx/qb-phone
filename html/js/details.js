function LoadPlayerMoneys(){
    ...
    var PlayerMCE = QB.Phone.Data.PlayerData.money.mce;
    var PlayerStateID = QB.Phone.Data.PlayerData.citizenid;
    var PlayerCraftingRep = QB.Phone.Data.PlayerData.metadata['craftingrep'];
    ...
    $(".details-millenniumcoin").html(PlayerMCE)
    $(".details-stateid").html(PlayerStateID)
    $(".details-craftingrep").html(PlayerCraftingRep)
